...
Поэтому если ваша планируемая выручка сильно меньше, то не нужно усложнять проект трудоемкими технологиями ради "оптимизаций" и "скорости", когда поп факту проблемы нет.
